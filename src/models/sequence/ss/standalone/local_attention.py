...
class LocalAttention(nn.Module):
    ...
    def forward(self, q, k, v, input_mask=None):
        ...
        q, k, v = map(merge_into_batch, (q, k, v))                  # (b*h t e)

        q, k, v = (pad_to_multiple(t, window_size, dim=-2) for t in (q, k, v))
        ...
        if not has_pykeops:
            ...
            dots = einsum('bwie,bwje->bwij', bq, bk)          # (b*h nw ws 3*ws)
